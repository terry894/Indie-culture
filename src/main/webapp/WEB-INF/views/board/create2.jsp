...
대한민국 대표 인디문화 커뮤니티
	...
	<div class="container">
					...
					<form name="BoardWriteForm" action="/board/create2" method="POST"
				...
				<tbody>
						...
						<form>
							<tr>
								...
								<option value="6">대관게시판</option>
						<option value="7">공연게시판</option>
								</select>
							...
							<tr>
								<th>공연장:</th>
								<td colspan="2"><select name="b_detail">
							<option value="">선택안함</option>
								<c:forEach items="${hall}" var="hall" >
								<option value="${hall.b_title}">${hall.b_title}</option>
						<</c:forEach>
								</select>
