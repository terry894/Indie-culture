...
대한민국 대표 인디문화 커뮤니티
    ...
    <div class="hero-inner group">
      <div class="hero-title">
        <span class="pre-head">other contents</span>
        <span class="blog-name">Others</span>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-8" style="margin-top: -40px; border: solid 2px fffff;" >
             ...
             <c:forEach items="${list }"  begin ="0"  end = "10"  step = "1" var="board">
            <!-- Blog Post -->
            <div class="card mb-4">
               <iframe src="/board/picture/${board.b_no}" height="300" width="100%" frameborder="0" marginwidth="0" marginheight="0"
></iframe>
  ...
  <div class="section">
  <div id="contents-tag">
    <h3  style= "font-family: 'Nanum Gothic', sans-serif;">개인정보   </h3>
   </div>
   <c:forEach items="${user}" var="user">
          <c:if test="${user.a_id eq b_writer }">
         <ul class="list-unstyled" >
            <li class="listyle"><span class="text-muted">이름: </span>${user.a_name}</li>   
                        <li class="listyle"><span class="text-muted">아이디: </span>${user.a_nick }</li>
                        <li class="listyle"><span class="text-muted">메일주소: </span>${user.a_email}</li>
                        <li class="listyle"><span class="text-muted">전화번호: </span>${user.a_phone }</li>
                     </ul>
                     </c:if>
            </c:forEach>
